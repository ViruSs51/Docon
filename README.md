...
3. **Run the following commands:**
    ...
    Alternatively, you can download the ZIP file directly from the [GitHub repository](https://github.com/ViruSs51/Docon/tree/master?tab=readme-ov-file#installation) and extract it.
