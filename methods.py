    ...
    async def generate_key(self,
        ...
        if key_not_exist:
            ...
            with open('docon-key-data.dcs', 'a') as docon_file:
                docon_file.write(f'{key_name}<separator>{self.data.key}\n')
